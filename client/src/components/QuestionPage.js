//const {questionCreate} = require("../../../server/add-data.js");
//import { questionCreate } from "../server/add-data.js";
  ...
  async function handleClick() {
    ...
    for (let i = 0; i < newTags.length; i++) {
      if (thold.indexOf(newTags[i]) !== -1) {
        ...
        // };
        // model.addTags(newT);
        props.addTag(newTags[i], q_id, currentUserId);
        props.refreshData();
      }
    }
